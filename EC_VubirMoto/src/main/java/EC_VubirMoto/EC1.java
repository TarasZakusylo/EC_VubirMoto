...
public class EC1 extends JFrame {
	...
	EC1(String s, final int ii_sl_putanna0, final int ii_sl_putanna1, final int ii_sl_putanna2,
		...
		l_komentar.setBounds(192, 69, 398, 14);
		...
		JButton b_vpered1 = new JButton("\u0412\u043F\u0435\u0440\u0435\u0434 3/5");
		b_vpered1.setFont(new Font("Times New Roman", Font.PLAIN, 20));
		...
		b_vpered1.setBounds(652, 517, 132, 36);
		getContentPane().add(b_vpered1);

		JButton b_nazad0 = new JButton("\u041D\u0430\u0437\u0430\u0434 1/5");
		b_nazad0.setFont(new Font("Times New Roman", Font.PLAIN, 20));
		...
		b_nazad0.setBounds(-1, 517, 132, 36);
